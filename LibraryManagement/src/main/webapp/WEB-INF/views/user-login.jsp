    	...
    	<main class="body">
        	<div class="row">
            	...
            	<div class="col-md-4 login-container">
     				<div class="header">
            			<img style = "margin-left:145px;" src="${pageContext.request.contextPath}/images/userlogo.jpg" width="20%" height="20%"alt="Library Logo" class="library-logo">
        		...
        		<c:when test="${changePasswordForm}">
        		...
        		<form action="/user/login" method="POST" ">
					...
					<c:if test="${cp}">
    					<p style="color:red; text-align:center">Password updated successful<br>Login with new Password </p>
					</c:if> 
					
					
					<c:if test="${userId > 0 }">
						<p style="text-align:center; color:green;">User registration successfully<br></p>
						<p style="text-align:center; color:red;">UserId : ${userId}</p>
					</c:if>
